  ...
  return (
    <>
      <section className="hero shell">
        ...
        <p>Run source-specific checks across companies, sponsorship, areas, property sales, regulated qualifications and food hygiene records.</p>
      ...
      <section className="shell category-grid" aria-labelledby="ways-to-check">
        ...
        {categories.map(({ icon: Icon, title, copy, href, live, tone }) => (
          <Link className={`category-card category-${tone}`} href={href} key={title}>
            ...
            {!live && <span className="category-state">Coming soon</span>}
