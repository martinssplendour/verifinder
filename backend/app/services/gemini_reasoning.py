...
class GeminiReasoner:
    ...
    async def interpret_question(
        ...
        instructions = (
            ...
            "industry must be exactly one of technology, financial services, healthcare, engineering, education, "
            "construction, hospitality, or null - map the user's wording onto that list rather than inventing a label. "
            "sponsorship_route must be exactly Skilled Worker, Scale-up, Global Business Mobility, or null. "
